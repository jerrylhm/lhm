...
//		System.out.println(ls.stream().map(name -> {
//			System.out.println(name);
//			return name.toLowerCase();}).collect(Collectors.toList()));
		
//		ls.stream().map(name -> {
//			return name.toLowerCase();}).filter(str -> str.equals("e")).forEach(System.out::println);

//		ls.stream().map(name -> {
//			return name.toLowerCase();}).skip(1).forEach(System.out::println);
		
//		ls.stream().map(name -> {
//			return name.toLowerCase();}).distinct().forEach(System.out::println);
		
//		ls.stream().mapToInt(num -> {
//			return Integer.valueOf(num);}).forEach(System.out::println);
